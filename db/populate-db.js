...
const insertDefaultStudiosData = async () => {
  const populateTableQuery = `INSERT INTO studios(name,description, img_url) VALUES
        ('Pixar','Pixar Animation Studios, is an American animation studio based in Emeryville, California, known for it''s commercially successful computer-animated feature films. Pixar is a subsidiary of Walt Disney Studios.','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbtR57h1_83-_ZzwJJSx6SBqPn_W1dHYTC8CuRJXaumXi2jfvOOaT-WJk&s=10'),
        ('Universal Pictures','Universal is an American film production and distribution company headquartered in Universal City, California.It''s most commercially successful film franchises include Fast & Furious, Jurassic Park, and Despicable Me','https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Universal_Pictures_logo.svg/960px-Universal_Pictures_logo.svg.png'),
        ...
        ('Lucasfilm','Lucasfilm Ltd. LLC is an American film and television production company founded by filmmaker George Lucas on December 10, 1971, in Marin County, California, in the city of San Rafael, and later moved to San Francisco in 2005.[2] It is best known for creating and producing the Star Wars and Indiana Jones franchises, as well as its leadership in developing special effects, sound, and computer animation for films. Since 2012, Lucasfilm has been a subsidiary of The Walt Disney Studios, who also owns former Lucasfilm subsidiary Pixar.','https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/1f2230f3-d395-4701-9831-457e72d51cdf/desq3yf-ba6836ed-dbf0-4ff2-92d3-d09129d3ca1a.png/v1/fill/w_1192,h_670,q_70,strp/lucasfilm_logo_on_screen_w_disney_byline_by_appleberries22_desq3yf-pre.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..WEEqAmmU0umkDhW96kQ8rUf-E5SyWlfVNvAx10ROT48')
        ;`;
